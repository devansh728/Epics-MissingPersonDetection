...
def send_match_notification(recipient_email, case_data, match_data, location_data, blockchain_hash):
    """
...
"""
        ...
        return send_email_with_attachment(recipient_email, subject, body, pdf_report_path)
